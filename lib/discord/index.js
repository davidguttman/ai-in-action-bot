      ...
      try {
        ...
        // --- Handle 'zoom_link' Intent ---
          ...
          if (zoomLink) {
            try {
              await message.reply(
                `Here's the zoom link for our meetings: ${zoomLink}`
              )
            } catch (replyError) {
            ...
            try {
              ...
              console.error('Failed to send no zoom link reply:', replyError)
            }
          }
        }
        // --- Handle 'other' or Unrecognized Intent ---
          ...
          try {
            await message.reply(
              "How can I help? You can ask me to 'sign up', 'view schedule', 'cancel talk', ask about past talks, or get the zoom link!",
            )
          } catch (e) {
            console.error(e)
          }
