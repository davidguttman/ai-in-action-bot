    ...
    if (
      ...
      try {
        ...
        // --- Handle 'other' or Unrecognized Intent ---
          ...
          try {
            await message.reply(
              "How can I help? You can ask me to 'sign up', 'schedule someone else', 'view schedule', 'cancel talk', ask about past talks, get the zoom link, or ask for the GitHub repository!",
            )
          } catch (e) {
            console.error(e)
          }
