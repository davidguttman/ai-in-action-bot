  ...
  return async function handleMessage(message) {
    ...
    if (!message.channel.isThread() && (trimmedContent.startsWith(mentionPrefix1) || trimmedContent.startsWith(mentionPrefix2))) {
      ...
      try {
        ...
        // other
        return message.reply("How can I help? You can ask me to 'sign up', 'schedule someone else', 'view schedule', 'reschedule talk', 'cancel talk', 'reschedule someone else', 'cancel someone else', ask about past talks, or get the zoom link!")
      } catch (e) {
